...
def main():
    ...
    # 读取 class_indict
    json_path = 'class_inception.json'
    ...
    # 创建模型
    model = InceptionV3(num_outputs=56, pretrained=True, dropout_p=0.5, task_type='multiclass_classification').to(device)

    # 加载模型权重
    weights_path = "./parameter/all-classify-inception.pth"
