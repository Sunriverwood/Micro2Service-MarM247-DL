...
def main():
    ...
    with open('class_res.json', 'w') as json_file:
    ...
    net = ResNet50(num_outputs=56, pretrained=True, dropout_p=0.5, task_type='multiclass_classification')
    ...
    epochs = 1000
    save_path = 'parameter/all-classify-res.pth'
    best_loss = float('inf')
