...
def main():
    ...
    data_transform = {
        ...
        "val": transforms.Compose([transforms.Resize((224, 224)),  #  must (224, 224)
                                   transforms.ToTensor(),
                                   transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])}
    ...
    epochs = 100
    save_path = '../tem_time_1/AlexNet.pth'
    best_acc = 0.0
    ...
    for epoch in range(epochs):
        ...
        print('[epoch %d] train_loss: %.3f  train_accuracy: %.3f  val_accuracy: %.3f' %
              (epoch + 1, running_loss / train_steps, train_accuracy, val_accurate))
